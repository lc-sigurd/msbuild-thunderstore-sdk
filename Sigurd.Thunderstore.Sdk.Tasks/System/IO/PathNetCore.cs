...
public static class PathNetCore
{
    ...
    {
#if NETFRAMEWORK
        return GetRelativePathShim(relativeTo, path, StringComparison.OrdinalIgnoreCase);
#else
...
#if NETFRAMEWORK
    // https://gist.github.com/antonKrouglov/07ccc117cb8c30ad8994446a86c062e
    // Copyright (c) 2018 Anton Krouglov
    private static string GetRelativePathShim(string relativeTo, string path, StringComparison comparisonType)
    {
